...
@section('content')
    ...
    <form action="{{ route('vacantes.store') }}" method="POST" class="max-w-xl mx-auto my-10 px-3 md:px-0">
        ...
        <div class="my-3">
            ...
            <input id="titulo" type="titulo" class="form-input w-full @error('titulo') border-red-500 @enderror"
                name="titulo" value="{{ $vacante->titulo }}" required autocomplete="email" autofocus>
        ...
        <div class="my-5">
            <label for="skills" class="block text-gray-700 text-sm mb-1"> Habilidades y conocimientos: </label>
            <span class="text-xs mb-5">(Elige al menos 3)</span>
            @php
